...
sudo rpm --import https://pkg.jenkins.io/redhat-stable/stable/jenkins.io-2023.key
sudo yum upgrade
...
baseurl=https://aquasecurity.github.io/trivy-repo/rpm/releases/$RELEASE_VERSION/\$basesearch/
gpgcheck=0
enabled=1
EOT
sudo yum -y update
