...
#cron job for auto discovery script
sudo echo "* * * * * ec2-user sh /etc/ansible/stage-discovery-script.sh" > /etc/crontab
sudo echo "* * * * * ec2-user sh /etc/ansible/prod-discovery-script.sh" > /etc/crontab
# Install New Relic
